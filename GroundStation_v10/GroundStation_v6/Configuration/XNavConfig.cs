...
namespace GroundStation
{
    public class XNavConfig
    {
        ...
        //Configurations
        private double[] Speedconfig = { -1, 0, 0, 0, 10, -10 }; //kp ki kd initialReference maxPitch minPitch
        private double[] Altitudeconfig = { 0.5, 0, 0, 200}; //kp ki kd initialReference
        private double[] Headingconfig = { 0.1, 0, 0, 0, 30}; //kp ki kd initialReference maxRoll
